...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Sistema de Directorio y Anuncios - Panel de Control">
    <meta name="author" content="Evilnapsis">
    <title>HYPERDIR - Panel de Administración</title>
    <!-- Vendors styles-->
    ...
    <style>
      ...
      .sidebar { background: #130f40 !important; }
      .sidebar-nav .nav-link:hover { background: rgba(255, 255, 255, 0.1); color: #fff; }
      .sidebar-nav .nav-link.active { background: rgba(255, 255, 255, 0.15) !important; color: #fff !important; border-left: 4px solid #fff; }
      .nav-title { color: #535c68 !important; font-weight: 700; letter-spacing: 1px; }
      ...
      .btn-primary { background: #130f40; border: none; border-radius: 10px; padding: 10px 20px; }
      .btn-primary:hover { background: #0c0930; }
      .text-indigo-400 { color: #fff !important; opacity: 0.8; }
      .text-indigo-600 { color: #130f40 !important; }
      .text-indigo-700 { color: #130f40 !important; font-weight: bold; }
      .text-indigo-900 { color: #130f40 !important; }
      .bg-indigo-50 { background-color: #f0f2f5 !important; }
      .bg-indigo-100 { background-color: #e2e8f0 !important; }
      .text-emerald-700 { color: #047857 !important; }
      .bg-emerald-100 { background-color: #d1fae5 !important; }
      .text-amber-700 { color: #b45309 !important; }
      .bg-amber-100 { background-color: #fef3c7 !important; }
      .btn-indigo { background-color: #130f40 !important; color: white !important; }
      .btn-indigo:hover { background-color: #0c0930 !important; }
    </style>
  </head>
  <body>
    ...
    <div class="sidebar sidebar-dark sidebar-fixed border-end" id="sidebar">
      <div class="sidebar-header border-bottom border-white border-opacity-10">
        <div class="sidebar-brand">
          <span class="sidebar-brand-full" style="font-size:20px; font-weight: 700;"><i class="bi bi-folder2-open me-2 text-indigo-400"></i>HYPERDIR</span>
          <span class="sidebar-brand-narrow">HD</span>
        </div>
      ...
      <ul class="sidebar-nav" data-coreui-navigation" data-simplebar="">
        ...
        <li class="nav-item">
          <a class="nav-link" href="./?view=posts&opt=all">
            <i class="nav-icon bi bi-megaphone"></i> Anuncios
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="./?view=pages">
            <i class="nav-icon bi bi-file-earmark-text"></i> Páginas
          </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="./?view=images&opt=all">
            <i class="nav-icon bi bi-images"></i> Galería
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="./?view=comments&opt=all">
            <i class="nav-icon bi bi-chat-dots"></i> Comentarios
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="./?view=msgs">
            <i class="nav-icon bi bi-envelope"></i> Mensajes
          </a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link" href="./?view=settings&opt=all">
            <i class="nav-icon bi bi-gear"></i> Configuración
          </a>
        </li>
      </ul>
    ...
    <div class="wrapper d-flex flex-column min-vh-100 bg-light bg-opacity-50">
          ...
          <ul class="header-nav">
            <li class="nav-item dropdown"><a class="nav-link py-0 pe-0" data-coreui-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                <div class="d-flex align-items-center">
                    ...
                    <div class="avatar avatar-md text-white d-flex align-items-center justify-content-center rounded-circle fw-bold shadow-sm" style="background:#130f40">
      ...
      <footer class="footer px-4 border-top-0 bg-transparent text-muted small pb-4">
        <div>HyperDir v2.0</div>
        <div class="ms-auto">Built with <i class="bi bi-heart-fill text-danger mx-1"></i> by Evilnapsis</div>
      </footer>
    </div>
    <?php else:?>
    <div class="min-vh-100 d-flex flex-row align-items-center" style="background: radial-gradient(circle at top right, #130f40, #000000);">
      <div class="container">
            ...
            <div class="card shadow-lg border-0 overflow-hidden" style="border-radius: 24px; background: rgba(255,255,255,0.9); backdrop-filter: blur(20px);">
              <div class="card-body p-5">
                <div class="text-center mb-5">
                  ...
                  <h1 class="h3 fw-bold text-indigo-900">HYPERDIR</h1>
                ...
                <form method="post" action="./?action=access&opt=login">
                  ...
                  <div class="d-grid shadow-indigo-200">
                    <button class="btn btn-indigo btn-lg shadow-sm fw-bold py-3 text-white" type="submit" style="background: #130f40; border:none; border-radius: 12px;">Entrar</button>
                  </div>
                </form>
              </div>
            </div>
