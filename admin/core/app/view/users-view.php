    ...
    <div class="col-md-12">
        <div class="d-flex align-items-center mb-4">
            <div>
                ...
                <p class="text-muted mb-0">Administra cuentas de acceso al sistema</p>
            </div>
            <div class="ms-auto">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php else: ?>
                                        <span class="badge bg-light text-muted rounded-pill px-3">Usuario</span>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <?php if($u->is_active): ?>
                                ...
                                <td class="pe-4 text-end">
                                    <button class="btn btn-light btn-sm" onclick="editUser(<?php echo $u->id; ?>)"><i class="bi bi-pencil"></i></button>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label small fw-bold" for="is_admin_check">¿Es Administrador?</label>
                            </div>
                        </div>
            ...
            <form id="edit-user-form">
                ...
                <div class="modal-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="is_admin" id="edit_user_is_admin">
                                <label class="form-check-label small fw-bold" for="edit_user_is_admin">¿Es Administrador?</label>
                            </div>
                        </div>
                        <div class="col-12 mt-2">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="is_active" id="edit_user_is_active">
                                <label class="form-check-label small fw-bold">Usuario Activo</label>
                            </div>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.editUser = function(id) {
        fetch('index.php?action=users&opt=get&id=' + id)
        .then(res => res.json()).then(u => {
            ...
            document.getElementById('edit_user_is_admin').checked = u.is_admin == 1;
            document.getElementById('edit_user_is_active').checked = u.is_active == 1;
