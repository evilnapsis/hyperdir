<?php
class CommentData extends Extra {
	...
	public function update(){
		$sql = "update ".self::$tablename." set name=\"$this->name\",content=\"$this->content\",is_public=\"$this->is_public\" where id=$this->id";
		Executor::doit($sql);
	}
	...
	public static function getLike($q){
		$sql = "select * from ".self::$tablename." where name like '%$q%' or content like '%$q%'";
		$query = Executor::doit($sql);
		return Model::many($query[0],new CommentData());
	}
